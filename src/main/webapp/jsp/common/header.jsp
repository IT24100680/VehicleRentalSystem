...
<nav class="navbar">
    <div class="container">
        <div class="nav-wrapper">
            <div class="logo">
                <img src="${pageContext.request.contextPath}/assets/images/vehicles/aaa.jpg" alt="AutoRent Logo" style="height: 40px; width: auto; margin-right: 10px; border-radius: 5px;">
                <span>AutoRent</span>
            </div>
